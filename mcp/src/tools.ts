...
export const toolDefinitions: ToolDefinition[] = [
  ...
  tool('start_operation', 'Capture an immutable input and start merge, export, negative conversion, AI masking/depth or local retouch in an independent native worker. Returns job_id. Editing remains available; cancellation stops only this worker.', { operation: z.enum(['merge', 'export', 'negative_convert', 'mask_generate', 'generate_depth', 'retouch']), arguments: record }, false, { host: true }),
