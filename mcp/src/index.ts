...
async function main(): Promise<void> {
  ...
  if (!binary || !workspace || !isAbsolute(binary) || !isAbsolute(workspace)) {
    throw new Error('Provide absolute --binary and --workspace paths, or RAPIDRAW_BINARY and RAPIDRAW_WORKSPACE. See --help.');
  }
