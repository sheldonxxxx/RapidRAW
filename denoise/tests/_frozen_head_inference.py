"""Frozen HEAD (f9729e0c) copy of rapidraw_denoise/inference.py for refactor-parity tests.

Only the relative imports were rewritten to absolute ones; all numerics are
untouched. Git blob 8d514969719422c5ded27c55ff76eed2ec9dd0be.
"""
"""Memory-bounded RAW inference with a frozen photometric noise profile."""
import time
import numpy as np
import torch
from rapidraw_denoise.noise import estimate_noise
from rapidraw_denoise.vendor.nonlocalmf.network import SimpleBlockMatchingUNet
