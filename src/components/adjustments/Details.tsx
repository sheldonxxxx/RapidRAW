      ...
      {adjustmentVisibility.sharpening !== false && (
        <div className="p-2 bg-bg-tertiary rounded-md">
          ...
          <Slider
            ...
            max={100}
            min={-100}
            onChange={(e) => handleAdjustmentChange(DetailsAdjustment.Sharpness, e.target.value)}
            step={1}
          ...
          {!isForMask && (
            <Slider
              ...
              max={80}
              min={0}
              onChange={(e) => handleAdjustmentChange(DetailsAdjustment.SharpnessThreshold, e.target.value)}
              step={1}
      ...
      {adjustmentVisibility.presence !== false && (
        <div className="p-2 bg-bg-tertiary rounded-md">
          ...
          <Slider
            ...
            max={100}
            min={-100}
            onChange={(e) => handleAdjustmentChange(DetailsAdjustment.Clarity, e.target.value)}
            step={1}
          ...
          <Slider
            ...
            max={100}
            min={-100}
            onChange={(e) => handleAdjustmentChange(DetailsAdjustment.Dehaze, e.target.value)}
            step={1}
          ...
          <Slider
            ...
            max={100}
            min={-100}
            onChange={(e) => handleAdjustmentChange(DetailsAdjustment.Structure, e.target.value)}
            step={1}
          ...
          {!isForMask && (
            <Slider
              ...
              max={100}
              min={-100}
              onChange={(e) => handleAdjustmentChange(DetailsAdjustment.Centré, e.target.value)}
              step={1}
      ...
      {adjustmentVisibility.noiseReduction !== false && (
        <div className="p-2 bg-bg-tertiary rounded-md">
          ...
          <Slider
            ...
            max={100}
            min={isForMask ? -100 : 0}
            onChange={(e) => handleAdjustmentChange(DetailsAdjustment.LumaNoiseReduction, e.target.value)}
            step={1}
          ...
          <Slider
            ...
            max={100}
            min={isForMask ? -100 : 0}
            onChange={(e) => handleAdjustmentChange(DetailsAdjustment.ColorNoiseReduction, e.target.value)}
            step={1}
      ...
      {!isForMask && adjustmentVisibility.chromaticAberration !== false && (
        <div className="p-2 bg-bg-tertiary rounded-md">
          ...
          <Slider
            ...
            max={100}
            min={-100}
            onChange={(e) => handleAdjustmentChange(DetailsAdjustment.ChromaticAberrationRedCyan, e.target.value)}
            step={1}
          ...
          <Slider
            ...
            max={100}
            min={-100}
            onChange={(e) => handleAdjustmentChange(DetailsAdjustment.ChromaticAberrationBlueYellow, e.target.value)}
            step={1}
